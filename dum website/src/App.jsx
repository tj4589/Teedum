...
export default function App() {
  ...
  // Handle Confetti firing when reaching result stage
  useEffect(() => {
    if (stage === "result") {
      const duration = 3000;
  ...
  const spin = () => {
    ...
    // Always spin but we don't care where it lands because we have a 'sike' result
    // Let's just do a random amount of spins
